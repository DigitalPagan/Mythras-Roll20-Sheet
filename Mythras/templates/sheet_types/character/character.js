...
on("clicked:import", function() {
    getAttrs(['import_json_data', 'import_character', 'setting', 'simplified_combat_enabled', 'action_points_calc'], function(v) {
        try {
            ...
            /*  TODO include spirit and social damage here or was it done in the skills import */
            setAttrs({
                ...newAttrs,
